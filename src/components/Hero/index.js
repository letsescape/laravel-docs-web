        ...
        <div className={styles.heroInner}>
          <div className={styles.heroContent}>
            <div className={styles.heroLogo}>
              <div className="hero-svg-logo" style={{width: '200px', height: '48px'}}>
                <svg className="w-full h-full text-laravel-red" width="200" height="48" viewBox="0 0 1280 308" fill="none" xmlns="http://www.w3.org/2000/svg">
